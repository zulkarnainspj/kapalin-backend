...
<body>
                    ...
                    <div class="mb-2">
                        <div class="form-group">
                                ...
                                @if ($i == 0)
                                    <div style="font-size:12px">
                                        <input class="form-check-input" type="checkbox" name="penumpang1"
                                            id="penumpang1">
                                        <label class="form-check-label" for="penumpang1" onchange="penumpangSatu()">Sama
                            ...
                            <input type="text" class="form-control mt-2" name="nama_penumpang[]"
                                ...
                                value="{{ old('nama_penumpang.' . $i) }}" autofocus>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control mt-2" name="no_id[]"
                        ...
                        <div class="col-md-12">
                            <div class="form-group mt-2">
                                ...
                                <input type="date" step="any" class="form-control mt-2" name="date_of_birth[]"
                                    value="{{ old('date_of_birth.' . $i) }}" id="date_of_birth">
                            </div>
                        </div>
                    </div>
                    <hr>
    ...
    <script>
        function penumpangSatu() {
            console.log($('#penumpang1').val());
            if ($('#penumpang1').attr("checked")) {
                console.log("OK");
            }
        }
    </script>
