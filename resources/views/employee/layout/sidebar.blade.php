            ...
            <div class="pb-6">
                ...
                <ul class="list-unstyled mb-6">
                    ...
                    <li class="menu-item {{ $nvb == 'schedules' ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="/employee/schedules/">
                            <span class="menu-icon">
                    ...
                    <li class="menu-item {{ ($nvb == 'ticket') ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="/employee/tickets/">
                            <span class="menu-icon">
                    ...
                    <li class="menu-item {{ ($nvb == 'passengers') ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="/employee/passengers/">
                            <span class="menu-icon">
